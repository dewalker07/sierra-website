                            ...
                            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <div className="slider_text_box">
                                    ...
                                    data-textalign="['left','left','left','left','left','center']">
                                        <img src="img/home-slider/slider-m-1.png" alt=""></img>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div className="container">
                        ...
                        <div className="row feature_inner">
                            <div className="col-lg-4 col-sm-6">
                                <div className="feature_item">
                                    <div className="f_icon">
                                        <img src="img/icon/f-icon-1.png" alt=""></img>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <div className="feature_item">
                                    <div className="f_icon">
                                        <img src="img/icon/f-icon-2.png" alt=""></img>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-6">
                                <div className="feature_item">
                                    <div className="f_icon">
                                        <img src="img/icon/f-icon-3.png" alt=""></img>
                                    </div>
                                    <h4>Social Media</h4>
                                    <p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit. Etiam nec odio vestibul. </p>
                                    <a className="more_btn" href="!#">Read More</a>
                    ...
                    <div className="right_text">
                        <div className="right_text_inner">
                            ...
                            <div className="shap_mobile">
                                <img src="img/iphone4.png" alt=""></img>
                            </div>
                        </div>
                    </div>
                </section>
            
                <div className="team_people_area">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-6">
                                            <div className="team_img_item">
                                                <img src="img/team/people/people-1.jpg" alt=""></img>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-6">
                                            <div className="team_img_item">
                                                <img src="img/team/people/people-2.jpg" alt=""></img>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-6">
                                            <div className="team_img_item">
                                                <img src="img/team/people/people-3.jpg" alt=""></img>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-6">
                                            <div className="team_img_item">
                                                <img src="img/team/people/people-4.jpg" alt=""></img>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="get_in_touch_area">
                    <div className="container">
                        <div className="row get_touch_inner">
                            <div className="col-lg-6">
                                <form className="contact_us_form row" id="contactForm" noValidate="noValidate">
